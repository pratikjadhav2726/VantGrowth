...
1. **Track B groundwork**
  ...
  - **Next milestones:** Phase 1 / S5 (92% → 100%): API-level authz guards for sensitive mutation routes + role matrix tests; Phase 0 / Track E (60% → 80%): AppRole/JWT for Vault; Phase 1 / S4: per-criterion LLM rubric checks.

...
1. **Track B groundwork**
   ...
   - **Next milestones:** Phase 1 / S5 (85% → 95%): session/auth layer; wire `postSignalGrade` in Signal Ingest page (optional preview); Phase 0 / Track E (60% → 80%): AppRole/JWT for Vault; Phase 1 / S4: per-criterion LLM rubric checks.

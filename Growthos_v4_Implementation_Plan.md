...
1. **Track B groundwork**
  ...
  - **Next milestones:** Phase 0 / Track E (95% → 100%): GitOps deploy (K3s manifest + Argo CD app definition + Pulumi infra stubs); Phase 1 / S5-S6 (97% → 100%): onboarding wizard + founder digest delivery (Postal).

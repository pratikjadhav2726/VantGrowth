...
1. **Track B groundwork**
  ...
  - **Next milestones:** Phase 0 / Track E (98% → 100%): wire CI image build + push, real secrets (External Secrets / Sealed Secrets) for API Deployments; Phase 1 / S5-S6: scheduled digest automation (cron) + persist settings server-side (replace dev cookies).
